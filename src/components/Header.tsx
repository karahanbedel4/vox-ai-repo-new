...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 bg-surface-container border-b border-card-border flex justify-between items-center px-4 max-w-md mx-auto shadow-md transition-all duration-300 ease-in-out pt-safe pt-[calc(0.5rem+env(safe-area-inset-top,0px))] ${

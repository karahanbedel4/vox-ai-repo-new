...
export const StreakWidget: React.FC<StreakWidgetProps> = ({ streakInfo, onOpenDetails }) => {
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden rounded-2xl p-4 transition-all duration-300 border backdrop-blur-xl shadow-md cursor-pointer group ${
        isTodayCompleted
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {isTodayCompleted && (
                <span className="inline-flex items-center gap-1 bg-amber-500/20 text-amber-400 border border-amber-500/30 text-[10px] font-extrabold px-2 py-0.5 rounded-full uppercase tracking-wider">
